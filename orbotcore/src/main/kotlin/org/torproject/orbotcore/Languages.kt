    ...
    companion object {
        ...
        fun setup(clazz: Class<*>?, resId: Int) {
            ...
            if (Companion.clazz == null) {
                ...
                throw RuntimeException("org.torproject.orbotcore.Languages singleton was already initialized, duplicate call to org.torproject.orbotcore.Languages.setup()!")
            }
        }
        ...
        operator fun get(activity: Activity): Languages {
            singleton = singleton ?: Languages(activity)
            return singleton as Languages
        }
